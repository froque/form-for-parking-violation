...
O gradle é usado para fazer o `build` dos projetos Apache Cordova. Instruções de instalação [aqui](https://docs.gradle.org/current/userguide/installation.html#linux_installation).
